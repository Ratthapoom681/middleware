...
class DefectDojoClient:
    ...
    def _build_findings_query_params(
        ...
        *,
        ...
        # These config flags are modeled as "... Only" toggles in the UI.
        # When disabled, omit the filter entirely so the API can return both
        # states instead of forcing only inactive/unverified findings.
